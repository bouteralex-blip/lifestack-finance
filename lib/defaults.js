...
export const DEFAULT_SECTOR = [
  {s:"Semis (SMH)",v:70,y:12},{s:"Comm Svcs",v:33.6,y:5.2},{s:"Info Tech",v:24,y:-2.1},{s:"Industrials",v:19.4,y:3.8},
  {s:"Financials",v:15,y:4.1},{s:"Healthcare",v:14.6,y:2.9},{s:"Energy",v:8.7,y:1.5},{s:"Software (IGV)",v:-30,y:-14},
];
