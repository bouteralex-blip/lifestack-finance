...
function classifyLeadership(ret12m, retYTD) {
  if (ret12m > 25 && retYTD > 5) return { tier: 'LEADING', color: '#22c55e', momentum: 'Strong' };
  if (ret12m > 15 || retYTD > 3) return { tier: 'IMPROVING', color: '#06b6d4', momentum: 'Positive' };
  if (ret12m > 0 && retYTD > -5) return { tier: 'NEUTRAL', color: '#f59e0b', momentum: 'Flat' };
  if (ret12m > -10) return { tier: 'LAGGING', color: '#f97316', momentum: 'Weak' };
