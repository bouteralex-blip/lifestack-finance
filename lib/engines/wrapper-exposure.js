 ...
 */
export function estimateCGTDrag(giaHoldings, annualTurnover = 0.15, cgtRate = 0.24, cgtAllowance = 3000) {
...
export function identifyReallocationOpps(wrapperSegments, isaAllowanceRemaining = 20000, cgtAllowance = 3000) {
  ...
  return sorted
    ...
    .map(h => {
      ...
      const annualBenefit = +(transferAmount * 0.08 * 0.24).toFixed(2); // 8% return × 24% CGT saved (additional rate)
