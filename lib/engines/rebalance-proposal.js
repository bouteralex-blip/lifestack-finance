 ...
 */
export function calculateCGTPerTrade(tradeAmount, avgGainPct = 0.08, cgtRate = 0.24, inWrapper = false) {
...
export function rankTradesByEfficiency(trades, cgtAllowanceRemaining = 3000) {
  ...
  return trades.map(t => {
    const cgtCost = calculateCGTPerTrade(t.amount, 0.08, 0.24, t.taxEfficiency >= 8);
