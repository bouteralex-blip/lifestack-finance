...
/**
 * OverlappingMountainAreaWidget.jsx
 *
 * Multi-series overlapping area (mountain) chart with translucent fills and neon strokes.
 *
 * Props:
 *   data     - Array of { date, ...seriesValues }
 *   series   - Array of { key, label, color, glowColor? }
...
export function OverlappingMountainAreaWidget({
  data,
  series,
  title = "Overlapping Mountain Chart",
  subtitle = "Multi-series area comparison",
}) {
  const uid = useId();
              ...
              <AreaChart data={data} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                ...
                {(series || []).map((s) => (
                  <Area
                    ...
                    style={{ filter: `drop-shadow(0 0 4px ${s.glowColor || s.color}40)` }}
                  />
                ))}
              </AreaChart>
            </ResponsiveContainer>
...
export default OverlappingMountainAreaWidget;
