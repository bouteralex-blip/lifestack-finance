...
const G=({children,span,accent,glow,style={}})=>{
  ...
  return(<div onMouseEnter={()=>setH(true)} onMouseLeave={()=>setH(false)} style={{
    background:T.glass,backdropFilter:"blur(20px) saturate(1.4)",WebkitBackdropFilter:"blur(20px) saturate(1.4)",
    border:`1px solid ${"rgba(255,255,255,0.08)"}`,borderRadius:T.glassRadius,position:"relative",overflow:"hidden",
    boxShadow:h?T.hShadow:(glow?`${T.shadow},0 0 30px rgba(245,166,35,0.12)`:T.shadow),
    transform:h?"translateY(-3px)":"none",transition:"all 0.25s cubic-bezier(0.4,0,0.2,1)",
    gridColumn:span?`span ${span}`:undefined,padding:20,
...
const PillLabel=({x,y,value,color=T.t1,bg="rgba(0,0,0,0.65)"})=>{
  if(!x||!y)return null;
  const w=String(value).length*6.5+16;
  return(<g><rect x={x-w/2} y={y-15} width={w} height={18} rx={9} fill={bg} stroke={color} strokeWidth={0.5} strokeOpacity={0.25}/><text x={x} y={y-3} textAnchor="middle" fill={color} fontSize={9} fontFamily={T.mono} fontWeight="600">{value}</text></g>);
};
...
const HExport=()=>(<button style={{background:"rgba(255,255,255,0.04)",border:`1px solid ${"rgba(255,255,255,0.08)"}`,borderRadius:8,padding:"4px 10px",color:T.t2,fontSize:9,cursor:"pointer",display:"flex",alignItems:"center",gap:4,fontFamily:T.mono}}><Download size={10}/>Export</button>);
...
const allocD=[{name:"ETFs",value:27.9,color:T.teal},{name:"Pension",value:23,color:T.violet},{name:"Cash/FD",value:16.4,color:T.sky},{name:"Crypto",value:13.6,color:T.amber},{name:"Investments",value:12.2,color:T.blue},{name:"Stocks",value:3.6,color:T.pink},{name:"Mixed",value:3.3,color:T.coral}];
const captureD=["Sep","Oct","Nov","Dec","Jan","Feb","Mar"].map((m,i)=>({m,up:[8,5,3,2,6,4,7][i],down:[-4,-8,-12,-6,-10,-14,-5][i]}));
const riskRetD=[{x:4,y:8,z:60,n:"Pension",c:T.violet},{x:8,y:-12,z:22,n:"BTC",c:T.amber},{x:3,y:7,z:24,n:"JURE",c:T.teal},{x:5,y:5,z:17,n:"JGEP",c:T.sky},{x:6,y:21,z:20,n:"ZAR",c:T.pink},{x:2,y:4,z:46,n:"FD",c:T.emerald}];
...
const holdingsAll=[{n:"Daiwa Pension",v:"\u00A360,275",w:"23.0%",r:"+28.6%",c:T.teal,cont:"+4.2%"},{n:"Fixed Deposit",v:"\u00A346,000",w:"17.5%",r:"+7.4%",c:T.teal,cont:"+0.6%"},{n:"JURE.L",v:"\u00A323,834",w:"9.1%",r:"+8.4%",c:T.teal,cont:"+0.7%"},{n:"BTC",v:"\u00A321,900",w:"8.3%",r:"-44.0%",c:T.coral,cont:"-3.5%"},{n:"ZAR Invest",v:"\u00A320,258",w:"7.7%",r:"+21.2%",c:T.teal,cont:"+1.5%"},{n:"Monzo Cash",v:"\u00A311,558",w:"4.4%",r:"+11.1%",c:T.teal,cont:"+0.3%"}];
  ...
  return(<div style={{minHeight:"100vh",fontFamily:T.sans,WebkitFontSmoothing:"antialiased",
    ...
    <div style={{padding:"20px 20px 60px",maxWidth:1400,margin:"0 auto",display:"flex",flexDirection:"column",gap:T.glassGap,position:"relative",zIndex:1}}>
          ...
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
            <div>
              ...
              <Plate><div style={{display:"flex",alignItems:"baseline",gap:6}}>
                <span style={{fontSize:24,fontWeight:700,color:T.t1,fontFamily:T.mono,letterSpacing:"-0.02em",textShadow:`0 0 20px ${k.ac}33`}}>{k.v}</span>
          ...
          <ResponsiveContainer width="100%" height={260}>
            <AreaChart data={edgeD}>
              ...
              <Area type="basis" dataKey="pension" stroke={T.violet} fill="url(#t1_pen)" strokeWidth={0} name="Pension"
                label={({x,y,value,index})=>index===0||index===6?<PillLabel x={x} y={y} value={`\u00A3${value}k`} color={T.violet}/>:null}/>
              <Area type="basis" dataKey="equity" stroke={T.teal} fill="url(#t1_eq)" strokeWidth={0} name="Equities"
                label={({x,y,value,index})=>index===3?<PillLabel x={x} y={y} value={`\u00A3${value}k`} color={T.teal}/>:null}/>
              <Area type="basis" dataKey="crypto" stroke={T.amber} fill="url(#t1_cr)" strokeWidth={0} name="Crypto"
                label={({x,y,value,index})=>index===0||index===6?<PillLabel x={x} y={y} value={`\u00A3${value}k`} color={T.amber}/>:null}/>
              <Area type="basis" dataKey="cash" stroke={T.emerald} fill="url(#t1_ca)" strokeWidth={0} name="Cash"
                label={({x,y,value,index})=>index===0||index===6?<PillLabel x={x} y={y} value={`\u00A3${value}k`} color={T.emerald}/>:null}/>
        ...
        <G accent={T.violet}>
          ...
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
            <div style={{flex:"0 0 100px"}}>
              ...
              <Plate><span style={{fontSize:24,fontWeight:700,color:T.t1,fontFamily:T.mono}}>5.2</span></Plate>
            ...
            <div style={{flex:"0 0 100px",textAlign:"right"}}>
              ...
              <Plate><span style={{fontSize:24,fontWeight:700,color:T.t1,fontFamily:T.mono}}>7.0</span></Plate>
        ...
        <G>
          ...
          <ResponsiveContainer width="100%" height={165}>
            <BarChart data={contribD} layout="vertical" barCategoryGap="16%">
              ...
              <Bar dataKey="v" radius={[0,4,4,0]} label={{position:"right",fontSize:8,fill:T.t2,fontFamily:T.mono,formatter:v=>`${v>0?"+":""}${v}k`}}>{contribD.map((d,i)=><Cell key={i} fill={d.v>=0?T.teal:T.coral} fillOpacity={0.8}/>)}</Bar>
            </BarChart>
          </ResponsiveContainer>
        ...
        <G>
          ...
          <ResponsiveContainer width="100%" height={145}>
            <BarChart data={monthlyR}><CartesianGrid stroke={T.grid} strokeDasharray="3 3"/>
              ...
              <YAxis tick={{fontSize:9,fill:T.t3}} axisLine={false} tickLine={false} tickFormatter={v=>`${v}%`}/>
              <ReferenceLine y={0} stroke="rgba(255,255,255,0.06)"/>
              <Bar dataKey="v" radius={[4,4,0,0]} label={{position:"top",fontSize:8,fill:T.t2,fontFamily:T.mono,formatter:v=>`${v>0?"+":""}${v}%`}}>{monthlyR.map((d,i)=><Cell key={i} fill={d.v>=0?T.teal:T.coral} fillOpacity={0.8}/>)}</Bar>
            </BarChart>
          </ResponsiveContainer>
        ...
        <G>
          ...
          <ResponsiveContainer width="100%" height={145}>
            <BarChart data={liqD} barCategoryGap="20%"><CartesianGrid stroke={T.grid} strokeDasharray="3 3"/>
              ...
              <Bar dataKey="v" radius={[4,4,0,0]} label={{position:"top",fontSize:8,fill:T.t2,fontFamily:T.mono,formatter:v=>`\u00A3${v}k`}}>{liqD.map((_,i)=><Cell key={i} fill={[T.teal,T.teal,T.sky,T.blue,T.violet,T.coral][i]} fillOpacity={0.8}/>)}</Bar>
            </BarChart>
          </ResponsiveContainer>
        ...
        <ResponsiveContainer width="100%" height={180}>
          <AreaChart data={scenD}>
            ...
            <Area type="monotone" dataKey="bull" stroke={T.teal} fill="url(#t1_sc1)" strokeWidth={2.5} dot={false} style={{filter:"drop-shadow(0 0 6px rgba(0,212,170,0.4))"}}
              label={({x,y,value,index})=>index===4?<PillLabel x={x} y={y} value={`\u00A3${value}k`} color={T.teal}/>:null}/>
            <Area type="monotone" dataKey="base" stroke={T.blue} fill="url(#t1_sc2)" strokeWidth={2} dot={false}
              label={({x,y,value,index})=>index===4?<PillLabel x={x} y={y} value={`\u00A3${value}k`} color={T.blue}/>:null}/>
            <Line type="monotone" dataKey="bear" stroke={T.coral} strokeWidth={2} dot={false} strokeDasharray="6 3"
              label={({x,y,value,index})=>index===4?<PillLabel x={x} y={y} value={`\u00A3${value}k`} color={T.coral}/>:null}/>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:T.glassGap}}>
        <G>
          <div style={{display:"flex",justifyContent:"space-between"}}><HTitle t="Top Holdings"/><Tag t="POSITION" c={T.t3}/></div>
          <table style={{width:"100%",borderCollapse:"collapse",marginTop:6}}>
            <thead><tr>{["Holding","Value","Wt","Ret","Ctb"].map((h,i)=>(<th key={i} style={{textAlign:i===0?"left":"right",fontSize:7,color:T.t3,fontFamily:T.mono,textTransform:"uppercase",letterSpacing:"0.06em",padding:"4px 4px",borderBottom:`1px solid ${T.grid}`}}>{h}</th>))}</tr></thead>
            <tbody>{holdingsAll.map((h,i)=>(<tr key={i} style={{borderBottom:`1px solid ${T.grid}`}}><td style={{padding:"4px",fontSize:10,color:T.t2}}>{h.n}</td><td style={{padding:"4px",fontSize:10,color:T.t1,fontFamily:T.mono,textAlign:"right"}}>{h.v}</td><td style={{padding:"4px",fontSize:10,color:T.t3,fontFamily:T.mono,textAlign:"right"}}>{h.w}</td><td style={{padding:"4px",fontSize:10,color:h.c,fontFamily:T.mono,fontWeight:600,textAlign:"right"}}>{h.r}</td><td style={{padding:"4px",fontSize:10,color:h.c,fontFamily:T.mono,textAlign:"right"}}>{h.cont}</td></tr>))}</tbody>
          </table>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:T.glassGap}}>
          {[{l:"Savings Rate",v:"38%",d:"+2pp",c:T.teal,avg:"Avg. 32%"},{l:"Runway",v:"4.2mo",d:"\u25BC 1.8",c:T.coral,avg:"Target: 3.0mo"},{l:"Debt Ratio",v:"0%",d:"Clear",c:T.teal,avg:"Amex cleared"},{l:"ISA Used",v:"\u00A320k",d:"Max",c:T.teal,avg:"100% utilised"},{l:"Pension YTD",v:"\u00A312.3k",d:"+\u00A38.3k",c:T.teal,avg:"Target \u00A360k"},{l:"DQS",v:"72",d:"+5",c:T.amber,avg:"Decision Quality"}].map((k,i)=>(<G key={i} style={{padding:12,textAlign:"center"}}>
            <div style={{fontSize:8,color:T.t3,fontFamily:T.mono,textTransform:"uppercase",letterSpacing:"0.06em",marginBottom:3}}>{k.l}</div>
            <Plate><span style={{fontSize:18,fontWeight:700,color:T.t1,fontFamily:T.mono}}>{k.v}</span></Plate>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:T.glassGap}}>
        {[
          ...
          <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:8}}><div style={{color:sec.c}}>{sec.icon}</div><span style={{fontSize:11,fontWeight:700,color:sec.c,textTransform:"uppercase",fontFamily:T.mono,letterSpacing:"0.06em"}}>{sec.t}</span></div>
      ...
      <div style={{textAlign:"center",padding:"14px 0",borderTop:`1px solid ${T.grid}`}}>
        <div style={{fontSize:8,color:T.t3,fontFamily:T.mono}}>CONFIDENTIAL \u00B7 Personal use only. Not investment advice. Source: Kubera + Monzo via Supabase. LifeStack OS v5.6 \u00B7 BadgerBrain Intelligence Engine.</div>
      </div>
