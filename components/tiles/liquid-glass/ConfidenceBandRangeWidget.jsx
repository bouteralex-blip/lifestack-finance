...
/**
 * ConfidenceBandRangeWidget.jsx
 *
 * Area chart with a central line and upper/lower confidence bands.
 * Shows a forecast with uncertainty bands using Recharts.
 *
 * Props:
 *   data     - Array of { date, value, upper, lower }
 *   title    - optional heading
 *   subtitle - optional secondary text
 *   lineColor     - default "#00E599"
 *   bandColor     - default "#00E599"
 *   bandOpacity   - default 0.12
 *
  ...
  return (
    ...
    >
      <div className="px-4 py-3">
        ...
        {upper && lower && (
          <span className="mt-0.5 block text-[10px] text-emerald-100/40">
            Band: {lower.value?.toLocaleString("en-GB")} - {upper.value?.toLocaleString("en-GB")}
          </span>
        )}
      </div>
    </div>
...
export function ConfidenceBandRangeWidget({
  data,
  title = "Confidence Range Forecast",
  subtitle = "Central estimate with upper/lower bands",
  lineColor = "#00E599",
  bandColor = "#00E599",
  bandOpacity = 0.12,
}) {
          ...
          <div className="h-[300px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={data} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                <defs>
                  <linearGradient id="bandGradUpper" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor={bandColor} stopOpacity={bandOpacity} />
                    <stop offset="100%" stopColor={bandColor} stopOpacity={0.02} />
                  </linearGradient>
                  <linearGradient id="bandGradLower" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor={bandColor} stopOpacity={0.02} />
                    <stop offset="100%" stopColor={bandColor} stopOpacity={bandOpacity} />
                  </linearGradient>
                </defs>
...
export default ConfidenceBandRangeWidget;
